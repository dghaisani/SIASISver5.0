...
import com.siasis.dalilahghaisani.siasisver50.Controller.ForumPol.PollingController;
import com.siasis.dalilahghaisani.siasisver50.Controller.SessionManager;
import com.siasis.dalilahghaisani.siasisver50.Model.Polling;
...
public class AdminPolFragment extends Fragment {
		...
		adminPolling.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!req.equals("")) {
					...
					AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AdminPolFragment.this.getActivity());
	...
	private class GetAllPolling extends AsyncTask<LinearLayout,Long,LinearLayout>
	{
		...
		private AdminPolFragment activity;

		public GetAllPolling(AdminPolFragment activity) {
		...
		protected void onPostExecute(LinearLayout a) {
            ...
            textView.setText("Silahkan tandai thread polling jadwal asistensi yang akan dihapus");
