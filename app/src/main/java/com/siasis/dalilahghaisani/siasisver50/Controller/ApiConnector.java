...
public class ApiConnector {
    ...
    public JSONArray GetAllCustomers()
    {
        ...
        String url = "http://ppl-getAllCustomers.php";
    ...
    public JSONArray GetPath(String username)
    {
        // URL for getting all customers
        String url = "http://ppl-a08.cs.ui.ac.id/mahasiswa.php?fun=getPath&Username="+username;
    ...
    public Boolean uploadImageToserver(List<NameValuePair> params) {
        ...
        // URL for getting all customers
        String url = "http://ppl-a08.cs.ui.ac.id/uploadImage.php";
